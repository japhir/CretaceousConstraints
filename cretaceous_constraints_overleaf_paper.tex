...
\rez{[hmm, this may seem important for astro, but less for geo.
perhaps:] An astronomically tuned time scale for the latest Cretaceous?}
}
...
The age model for the Zumaia and Sopelana sites was \rez{is?} based on the identification of long eccentricity minima in the field \citeA{Batenburg2012,Batenburg2014}.
...
In order to test which astronomical solution \rez{provides the best match to the data (end hence a proper astronomical time scale)} we adopt and extend the approach of \citeA{ZeebeLourens2019,ZeebeLourens2022EPSL}.
