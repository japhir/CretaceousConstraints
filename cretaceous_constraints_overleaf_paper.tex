...
\begin{figure}[htb]
  ...
  \caption{\label{fig:full-RMSD-filter}
    ...
    \ijk{TODO: I've figured out the parametrization, should be able to fix this so it's less confusing.}
...
\begin{figure}[htb]
  ...
  \caption{\label{fig:filter-windows}
    ...
    Therefore, we also show a reparametrized filter, where the upper and lower boundaries correspond to \(-\sigma\) and \(+\sigma\).
    This was determined by experimentally multiplying the fraction of the target frequency added/subtracted for the lower and upper bounds
    until we found that a value of 3 matched a true normal distribution best.
