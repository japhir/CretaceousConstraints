...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{full_RMSD_scores.pdf}
    \caption{\label{fig:full-RMSD}
        \gls{RMSD} scores of compilation of Zumaia and Sopelana \gls{L*} record against several orbital solutions.
