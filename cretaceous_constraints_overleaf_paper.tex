...
Here we assume independent durations of \qty{405}{\kiloyear} for each of these long eccentricity cycles to arrive at an initial floating age model.
...
The detrended data (\cref{sec:detrend}) is combined with the initial age model (\cref{sec:agemodel}) to get data in the time domain.
...
Especially cycle \(\text{Ma}_{405}8\) shows a very large amplitude in the short eccentricity filter, which relates to the darker interval at around \qty{117}{\metre}.
