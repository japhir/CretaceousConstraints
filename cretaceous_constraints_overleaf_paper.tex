...
If we look at the available proxy archives, however, none seem to have a large amplitude of the multiple short eccentricity related cycles during \ma{2}.
...
Note that \citeA{Batenburg2018} reconstruct a large amplitude in the short eccentricity component of \ma{5}, which is in agreement with the present study.
The \gls{MS} record from ODP Leg 208 Site 1267B, spanning \ma{1--6.5} shows a single large peak within \ma{2}, while the smoothed gray level of ODP Leg 122 Site 762C showed a small amplitude in \ma{2}~\cite<Fig. 4 in>[]{Husson2011}.
...
\ijk{[This paragraph might need some work!]}
