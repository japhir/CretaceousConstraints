...
\begin{table}
    ...
    \begin{tabular}{llccl}
        ...
        \hline
        208-1262 & a*, d13C, d18O & - & 58--53 & \citeA{ZeebeLourens2019} \\ % should probably cite OG study but won't show in final table here anyway
        ...
        Zumaia & CaCO3 & -3--4 & & \citeA{tenKateSprenger1993}\\ % too short?
        ...
        % Gubbio & MS & - & OAE-2 & \citeA{Kitch2023}\\ % low-res
        198-1210B & d13C, d18O,XRF Ba & 2--12 & 71.5--66.25 & \citeA{Jung2012,Kim2022}\\ % some low-res intervals in crucial parts? higher res around 68 Ma
        74-525A & grayscale & 6--8.5 & 69--67.8 & \citeA{Husson2011}\\ % have emailed requesting data, but has left academia
        207-1258B & L* etc. & 8--14 & - & \citeA{Husson2011}\\ % can reproduce by getting data from JANUS database
        ...
        Gubbio & d13C, d18O & - & 84.2--72.1 & \citeA{Sabatino2018}\\
    ...
    \caption{\label{tab:sites}
        ...
        Gubbio consists of Contessa Highway (Danian) section and Bottaccione (Maastrichtian) section.
    }
...
We remove long-term trends in the record using various strategies because there are a few significant shifts in the lithology (red, clay-rich intervals and whiter marl-rich intervals) that could hamper spectral analysis and filtering.
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{full_RMSD_scores.pdf}
    \caption{\label{fig:full-RMSD}
        ...
        % TODO: remove low-scoring lower opacity lines?
    }
\end{figure}
