...
\item Geological data can be used to constrain the chaos of Earth's orbital past.
\item The Zumaia and Sopelana terrestrial sections are most compatible with solution ZB20a for the Maastrichtian.
...
%Problem
Astronomical solutions form the backbone of precise and accurate dating for geology and paleoclimate studies.
...
Geological data have been used to constrain this chaos in order to arrive at a geologic time scale up to the \acrlong{KT}.
%Action
...
%Results
We find that the filtered \gls{L*} record is most compatible with astronomical solution ZB20a.
However, these results are sensitive to parameter choices in our algorithm, which we describe in detail.
Nevertheless, \gls{VLN} in the astronomical solutions that coincide with very high amplitudes in the short eccentricity-related peaks in the filtered proxy record give a clear indication on why the ZB20a solution should be favored when performing cyclostratigraphy for the latest Cretaceous.
