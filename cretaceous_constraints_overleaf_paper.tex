...
\begin{figure}[htb]
  \centering
  \includegraphics[width=\textwidth]{rolling_age_overview_new.png}
  \caption{\label{fig:rolling-rmsd}
    ...
    %after iteratively shifting the long eccentricity minima tiepoints by small increments up to \textpm\qty{1.6}{\metre} (see text) and calculating the \gls{RMSD} for the whole record at each iteration to decide which tiepoint error gives the best fit .
...
\begin{figure}[htb]
  \centering \includegraphics[width=\textwidth]{new_rolling_improvement.png}
