...
In conclusion, we recommend using the ZB20a solution for astronomical tuning of eccentricity-related cycles up to \appr\qty{71}{\millionyearago}, because it is the most compatible with available geological records.
