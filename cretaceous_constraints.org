...
#+RESULTS:
: indexing 405_minima.csv [==========================================================] 137.09MB/s, eta:  0s                                                                                                                                            Rows: 20 Columns: 5
: ── Column specification ─────────────────────────────────────────────────────────────────────────────────
: Delimiter: ","
...
**** combine filters
:PROPERTIES:
:CREATED:  [2023-09-28 Thu 13:23]
:END:
#+begin_src R
  combine_filters <- function(data, freqs, x, y, nest) {
    data |>
      mutate(scl = scale({{y}})[, 1]) |>
      nest(.by = c(nest)) |>
