...
#+begin_src R
  ...
  sedrange <- seq(0, 2, 0.2)[-1] * 1e-2 # change sedrate by ±1 cm
...
#+RESULTS:
:  [1] -0.020 -0.018 -0.016 -0.014 -0.012 -0.010 -0.008 -0.006 -0.004 -0.002  0.000  0.002  0.004  0.006  0.008  0.010  0.012  0.014  0.016  0.018  0.020
...
#+begin_src R :results output
  best <- msd |>
    ...
    tidylog::filter(RMSD == min(RMSD, na.rm = TRUE),
...
#+RESULTS:
#+begin_example
filter: removed 6,440 rows (>99%), 28 rows remaining
# A tibble: 28 × 12
 ...
 1 Lstar Zumaia   lin_scl_fine 1:1   depth >= 109.26   65860    0.0391  0.0231    -0.016        -40 ZB20a  1.26
 2 Lstar Sopelana lin_scl_fine 1:1   full record       65700    0.0368  0.0348    -0.002       -200 ZB18a  1.27
 3 Lstar Zumaia   lin_scl_fine 1:1   depth < 109.26    65900    0.0385  0.0385     0              0 ZB20a  1.27
 4 Lstar Zumaia   lin_scl_fine 1:1   depth >= 109.26   65820    0.0391  0.0331    -0.006        -80 La10c  1.29
 5 Lstar Zumaia   lin_scl_fine 1:1   depth < 109.26    65940    0.0385  0.0385     0             40 La10b  1.29
 6 Lstar Zumaia   lin_scl_fine 1:1   depth >= 109.26   65860    0.0391  0.0251    -0.014        -40 ZB20c  1.29
 7 Lstar Zumaia   lin_scl_fine 1:1   depth >= 109.26   65900    0.0391  0.0251    -0.014          0 ZB20b  1.31
 8 Lstar Zumaia   lin_scl_fine 1:1   depth < 109.26    65980    0.0385  0.0405     0.002         80 ZB20b  1.31
 9 Lstar Sopelana lin_scl_fine 1:1   full record       65860    0.0368  0.0428     0.006        -40 La10c  1.31
10 Lstar Zumaia   lin_scl_fine 1:1   full record       66020    0.0435  0.0415    -0.002        120 ZB20a  1.32
# ℹ 18 more rows
# ℹ Use `print(n = ...)` to see more rows
#+end_example
...
#+begin_src R :results output graphics file :file imgs/Zumaia_MSD-overview.png :width 3400 :height 2600 :res 300
  msd |>
   ...
   ## ) +
    scale_x_reverse() +
    scale_colour_distiller(type = "div", palette = 2) +
    ## scale_colour_viridis_c() +
    labs(
