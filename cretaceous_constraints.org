...
#+RESULTS:
: indexing 405_minima.csv [===============================================================================================================] 199.93MB/s, eta:  0s                                                                                                                                                                                                 Rows: 20 Columns: 5
: ── Column specification ──────────────────────────────────────────────────────
: Delimiter: ","
  ...
  smooth_all <- smooth_basic |>
    ...
    tidylog::left_join(
               ...
               rename(lin_pred_med = lin_pred,
                      ...
                      lin_scl_med = lin_scl)) |>
    ## bind_rows(smooth_hp) |>
    pivot_longer(c(value, scl, lin_rw, lin_gam, lin_fine, lin_med, lin_coarse, lin_scl_rw, lin_scl_fine, lin_scl_med, lin_scl_coarse, gam_scl, gam_pred, lin_pred_rw, lin_pred_fine, lin_pred_med, lin_pred_coarse, lin_gam_pred, lin_gam_scl),
...
#+begin_src R :results output graphics file :file imgs/Zumaia-Sopelana_detrend_types_all.png :width 2400 :height 2200 :res 300 :eval never
  smooth_all |>
    ...
    filter(!detrend_type %in%
           c("lin_rw", "lin_coarse", "lin_med", "lin_fine", "lin_gam",
...
#+RESULTS:
#+begin_example
filter: removed 56,793 rows (62%), 34,933 rows remaining
filter: removed 44,989 rows (43%), 59,810 rows remaining
# A tibble: 8 × 1
  detrend_type
  <chr>
1 value
...
#+begin_src R :results output graphics file :file imgs/new_rolling_improvement.png :width 2400 :height 2000 :res 300
  best_age_optim |>
    ...
    labs(
      ...
      shape = "Age model",
      linetype = "Age model") +
    facet_grid(cols = vars(proxy, comb), rows = vars(site, depth_chunk),
