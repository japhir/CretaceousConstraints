...
#+begin_src R
  diffs_tie <- data_ecc |>
    ...
    mutate(age = case_when(
             ...
             sol == "ZB18a" & tie_err == -2. ~
               Hmisc::approxExtrap(agem_tie$strat_bot[agem_tie$sol == "ZB18a" & agem_tie$tie_err == -2],
                                   agem_tie$age[agem_tie$sol == "ZB18a" & agem_tie$tie_err == -2],
                                   xout = depth)$y,
             sol == "ZB18a" & tie_err == -1. ~
               Hmisc::approxExtrap(agem_tie$strat_bot[agem_tie$sol == "ZB18a" & agem_tie$tie_err == -1],
                                   agem_tie$age[agem_tie$sol == "ZB18a" & agem_tie$tie_err == -1],
                                   xout = depth)$y,
             sol == "ZB18a" & tie_err == 0. ~
               Hmisc::approxExtrap(agem_tie$strat_bot[agem_tie$sol == "ZB18a" & agem_tie$tie_err == 0],
             ...
             sol == "ZB20a" & tie_err == -2. ~
               Hmisc::approxExtrap(agem_tie$strat_bot[agem_tie$sol == "ZB20a" & agem_tie$tie_err == -2],
                                   agem_tie$age[agem_tie$sol == "ZB20a" & agem_tie$tie_err == -2],
                                   xout = depth)$y,
             sol == "ZB20a" & tie_err == -1. ~
               Hmisc::approxExtrap(agem_tie$strat_bot[agem_tie$sol == "ZB20a" & agem_tie$tie_err == -1],
                                   agem_tie$age[agem_tie$sol == "ZB20a" & agem_tie$tie_err == -1],
                                   xout = depth)$y,
             sol == "ZB20a" & tie_err == 0. ~
               Hmisc::approxExtrap(agem_tie$strat_bot[agem_tie$sol == "ZB20a" & agem_tie$tie_err == 0],
             ...
             sol == "La11" & tie_err == -2. ~
               Hmisc::approxExtrap(agem_tie$strat_bot[agem_tie$sol == "La11" & agem_tie$tie_err == -2],
                                   agem_tie$age[agem_tie$sol == "La11" & agem_tie$tie_err == -2],
                                   xout = depth)$y,
             sol == "La11" & tie_err == -1. ~
               Hmisc::approxExtrap(agem_tie$strat_bot[agem_tie$sol == "La11" & agem_tie$tie_err == -1],
                                   agem_tie$age[agem_tie$sol == "La11" & agem_tie$tie_err == -1],
                                   xout = depth)$y,
             sol == "La11" & tie_err == 0. ~
               Hmisc::approxExtrap(agem_tie$strat_bot[agem_tie$sol == "La11" & agem_tie$tie_err == 0],
...
#+begin_src R :results none
  # which comb and detrend_type get the best scores?
  # This means we shouldn't group by Ma405 yet!!!
  diffs_tie |>
      summarize(RMSD = sqrt(mean(SD)),
                .by = c(proxy, site, comb,
                        detrend_type,
    ...
    arrange(RMSD) |>
    tidylog::filter(RMSD == min(RMSD),
                    .by = c(proxy, site, filt_env, ## detrend_type,
                            sol))
...
#+begin_src R :results output graphics file :file imgs/best_fits_tiepoints.png :width 1200 :height 800
  ...
  diffs_tie |>
    ...
    geom_text(aes(x = age / 1e3, y = 3.7,
              ...
              data = diffs_tie |>
                inner_join(best_tie) |>
                summarize(age = mean(age), RMSD = mean(RMSD),
...
If we select the Ma405 cycles with the /best/ RMSD scores, this means that for some they'll get a tiepoint uncertainty of +2 m and for the next cycle -2 m, resulting in overlapping depths getting mapped to the same age.
