...
#+RESULTS:
: indexing 405_minima.csv [==========================================================] 261.72MB/s, eta:  0s                                                                                                                                            Rows: 20 Columns: 5
: ── Column specification ─────────────────────────────────────────────────────────────────────────────────
: Delimiter: ","
...
#+begin_src R :results output graphics file :file imgs/Zumaia_ecc_RMSD.png :width 800
  msd |>
...
|-------+--------+-------+----------+-----+---------+-------+------------------|
| d13C  | Zumaia | 0.5:1 | filter   |  22 |   65920 | La11  |  1.0453620169081 |
| Lstar | Zumaia | 0.5:1 | filter   |  23 |   65920 | ZB20a | 1.11284173766877 |
| MS    | Zumaia | 0.5:1 | filter   |  24 |   65980 | ZB18a | 1.14551836865348 |
...
| sol   |       mean(RMSD) |
|-------+------------------|
| La11  | 1.29400074772856 |
| ZB20a | 1.31374321786202 |
| ZB18a | 1.33408159569711 |
  ...
  diffs_tie <- data_ecc |>
    ...
    mutate(Ma405 = Hmisc::approxExtrap(agem_simple$strat_bot, agem_simple$n,
                                       xout = depth)$y |>
                                                    floor()) |>
    nest(.by = Ma405) |>
    # tiepoint uncertainty in metres
    mutate(tiepoint_uncertainty = list(seq(-4, 4, 1))) |> # ±4 metres may be a bit excessive
    unnest(cols = c(tiepoint_uncertainty)) |>
    unnest(cols = c(data)) |>
    mutate(age = kpg_age +
