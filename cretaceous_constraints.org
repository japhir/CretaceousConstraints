...
#+begin_src R :exports both
  ...
  agem_tie <- agem_sol |>
    ...
    unnest(tie_err) |>
    mutate(tie_depth = strat_bot + tie_err)
...
#+RESULTS:
: indexing 405_minima.csv [===============================================================================================================] 228.49MB/s, eta:  0s                                                                                                                                                                                                 Rows: 20 Columns: 5
: ── Column specification ─────────────────────────────────────────────────────────────────────────────────
: Delimiter: ","
...
#+begin_src R :results output graphics file :file imgs/Zumaia_MSD-overview.png :width 800
  msd |>
    ...
    geom_line(aes(group = paste(inv_sedrate, comb, filt_env, detrend_type#inv_sedrate
                                )), linewidth = .7
              ) +
...
#+begin_src R :results output graphics file :file imgs/Zumaia_ecc_RMSD.png :width 400 :height 1200
  msd |>
    ...
    facet_grid(rows = vars(site, proxy, sol, # , proxy_lag
                           ),
               cols = vars(detrend_type, filt_env, comb)) +
    ## geom_line() +
    geom_raster() +
...
|-------+----------+--------------+-------+----------+---------+-------------+-------+-------------------|
| Lstar | Sopelana | lin_gam_det  | 1:0.5 | filter   |   66020 |        27.5 | La11  | 0.965219296906945 |
...
| MS    | Sopelana | gam_det      | 1:0.5 | filter   |   65940 |        24.5 | La11  |  1.04892771412354 |
...
# A tibble: 15 × 4
   proxy site     sol    RMSD
   <chr> <chr>    <chr> <dbl>
 1 Lstar Sopelana La11  1.28
 2 Lstar Sopelana ZB18a 1.42
 3 Lstar Sopelana ZB20a 1.12
 4 MS    Sopelana La11  1.03
 5 MS    Sopelana ZB18a 1.22
 6 MS    Sopelana ZB20a 0.900
 7 Lstar Zumaia   La11  1.29
 8 Lstar Zumaia   ZB18a 1.20
 9 Lstar Zumaia   ZB20a 1.29
10 MS    Zumaia   La11  1.29
11 MS    Zumaia   ZB18a 1.19
12 MS    Zumaia   ZB20a 1.31
13 d13C  Zumaia   La11  1.24
14 d13C  Zumaia   ZB18a 1.26
15 d13C  Zumaia   ZB20a 1.21
#+end_example
...
Interestingly, for this 405 kyr minima age model it seems that:
...
#+RESULTS:
: filter: removed 14,760 rows (80%), 3,690 rows remaining
: + Joining with `by = join_by(Ma405, proxy, site, detrend_type, comb, filt_env, tie_err, sol)`
: inner_join: added one column (RMSD)
: rows only in x  (1,558,440)
: rows only in y  (        0)
: matched rows       389,610
:                 ===========
: rows total         389,610
: summarize: now 450 rows and 7 columns, ungrouped
...
# A tibble: 15 × 7
 ...
 1 d13C  Zumaia   1:1   filter   scl          ZB18a 0.977
 2 d13C  Zumaia   1:1   filter   scl          La11  1.02
 3 d13C  Zumaia   1:1   filter   scl          ZB20a 0.990
 4 MS    Zumaia   1:1   filter   scl          ZB18a 0.940
 5 MS    Zumaia   1:1   filter   scl          La11  1.10
 6 Lstar Zumaia   1:1   filter   scl          ZB18a 1.01
 7 Lstar Zumaia   1:1   filter   scl          ZB20a 1.01
 8 Lstar Zumaia   1:1   filter   scl          La11  1.07
 9 MS    Zumaia   1:1   filter   scl          ZB20a 1.03
10 Lstar Sopelana 1:1   filter   scl          ZB18a 1.03
11 MS    Sopelana 1:1   filter   scl          ZB18a 0.783
12 Lstar Sopelana 1:1   filter   scl          La11  1.12
13 MS    Sopelana 1:1   filter   scl          ZB20a 1.01
14 MS    Sopelana 1:1   filter   scl          La11  0.919
15 Lstar Sopelana 1:1   filter   scl          ZB20a 1.14
#+end_example
