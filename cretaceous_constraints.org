...
: 3 prec       22 0.0455  0.0136   0.0318  0.0591  This study  31.4  16.9
...
#+begin_src R :results output graphics file :file imgs/Zumaia_Sopelana_spectra_filters.png :width 1200 :height 900
  ...
  specs_age |>
    ...
    ggplot(aes(x = freq, y = power, colour = detrend_type)) +
...
#+attr_latex: :width \linewidth
#+caption: Zumaia/Sopelana spectral analysis after tuning each of the 405 kyr minima from the field [cite:@Batenburg2012] to 405 kyr mimima in each of the orbital solutions.
#+RESULTS:
...
#+begin_src R :results output graphics file :file imgs/Zumaia_Sopelana_records_and_filters.png :width 1200 :height 900
  smooth_ages |>
    ...
    geom_line(aes(y = envelope + 3.5, group = paste(detrend_type, site)),
              data = hb_age_prec |> filter(detrend_type != "value")) +
    geom_point(aes(y = pk),
               size = 3,
               data = filts_age |>
