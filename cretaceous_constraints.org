...
: filter: removed 8,353 rows (41%), 11,889 rows remaining
...
**** simple plot of records vs. solutions
:PROPERTIES:
...
#+begin_src R :results output graphics file :file imgs/sol_SD.pdf :width 7 :height 7
  overall_sd |>
    ...
    scale_colour_manual(name = "", values = c("Proxy" = "purple", "Solution" = "black")) +
    ...
    ##                 ymax = scale(SD)[, 1] - 8),
    ##             fill = "black", alpha = .3) +
    geom_line(aes(y = -ecc, group = site, colour = "Proxy")) +
