...
#+RESULTS:
:  [1] -0.020 -0.018 -0.016 -0.014 -0.012 -0.010 -0.008 -0.006 -0.004 -0.002
: [11]  0.000  0.002  0.004  0.006  0.008  0.010  0.012  0.014  0.016  0.018
: [21]  0.020
...
# A tibble: 28 × 12
   proxy site     detrend_type comb  depth_chunk     kpg_age m_per_kyr sedrate
   <chr> <chr>    <chr>        <chr> <chr>             <dbl>     <dbl>   <dbl>
 1 Lstar Zumaia   lin_scl_fine 1:1   depth >= 109.26   65860    0.0391  0.0231
 2 Lstar Sopelana lin_scl_fine 1:1   full record       65700    0.0368  0.0348
 3 Lstar Zumaia   lin_scl_fine 1:1   depth < 109.26    65900    0.0385  0.0385
 4 Lstar Zumaia   lin_scl_fine 1:1   depth >= 109.26   65820    0.0391  0.0331
 5 Lstar Zumaia   lin_scl_fine 1:1   depth < 109.26    65940    0.0385  0.0385
 6 Lstar Zumaia   lin_scl_fine 1:1   depth >= 109.26   65860    0.0391  0.0251
 7 Lstar Zumaia   lin_scl_fine 1:1   depth >= 109.26   65900    0.0391  0.0251
 8 Lstar Zumaia   lin_scl_fine 1:1   depth < 109.26    65980    0.0385  0.0405
 9 Lstar Sopelana lin_scl_fine 1:1   full record       65860    0.0368  0.0428
10 Lstar Zumaia   lin_scl_fine 1:1   full record       66020    0.0435  0.0415
# ℹ 18 more rows
# ℹ 4 more variables: sed_error <dbl>, age_offset <dbl>, sol <chr>,
#   RMSD <dbl>
# ℹ Use `print(n = ...)` to see more rows
#+end_example
...
#+begin_src R :results output graphics file :file imgs/Zumaia_ecc_RMSD.png :width 1200 :height 2200 :res 300
  ...
  msd |>
    ...
    geom_raster() +
    ## geom_rect()
    ## geom_point(aes(colour = RMSD), size = .6, shape = "■")
