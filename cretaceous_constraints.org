...
#+RESULTS:
: indexing 405_minima.csv [==========================================================] 110.73MB/s, eta:  0s                                                                                                                                            Rows: 20 Columns: 5
: ── Column specification ─────────────────────────────────────────────────────────────────────────────────
: Delimiter: ","
...
#+begin_src R
  ...
  msd <- diffs |>
    summarize(RMSD = sqrt(mean((ecc - ecc_sln)^2)),
...
#+begin_src R :results output graphics file :file imgs/Zumaia_ecc_MSD.png :width 1920 :height 800
  msd |>
...
**** NEXT Do the RMSD analysis with 405 kyr tie-points and variable sedimentation rates
:PROPERTIES:
:CREATED:  [2023-10-02 Mon 17:25]
:END:
