...
#+begin_src R
  smooth <- comp |>
    ...
    ## mutate(lm = map(data, ~ lm(value ~ depth, data = .)))
    mutate(gam = map(data,
...
----- BANDPASS FILTERING STRATIGRAPHIC SERIES-----
 ...
 ,* Center of bandpass filter = 0.05416667
 ,* 16 pos/neg frequency pairs will be bandpassed

----- BANDPASS FILTERING STRATIGRAPHIC SERIES-----
 ,* Number of data points= 1344
 ,* Sample interval= 0.105
 ,* Mean value removed= -0.03224345
 ,* Center of bandpass filter = 0.06439394
...
----- BANDPASS FILTERING STRATIGRAPHIC SERIES-----
 ...
 ,* Center of bandpass filter = 0.05416667
 ,* 6 pos/neg frequency pairs will be bandpassed
...
#+RESULTS:
: indexing 405_minima.csv [==========================================================] 104.31MB/s, eta:  0s                                                                                                                                            Rows: 20 Columns: 5
: ── Column specification ────────────────────────────────────────────────────────
: Delimiter: ","
