...
These sections may be of particular interest:
- [[#table-of-final-age-model][table of final age model]]
- [[#a-wrap_age_model-for-all][wrap_age_model for all]]: where I set up simulation grids for the sensitivity analysis

:CONTENTS:
- [[#libraries][libraries]]
- [[#plot-astronomical-solutions][plot astronomical solutions]]
- [[#what-are-the-differences-between-405-kyr-minima][what are the differences between 405-kyr minima?]]
- [[#plot-the-difference-between-vln-ages][plot the difference between VLN ages]]
- [[#datasets-from-the-literature][Datasets from the Literature]]
  - [[#zumaia-and-sopelana][Zumaia and Sopelana]]
    - [[#read-the-data][Read the data]]
    - [[#create-tables-with-ranges-of-bp-filters-in-depth-domain][create tables with ranges of bp filters in depth domain]]
    - [[#subtract-the-long-term-trends][subtract the long-term trends]]
    - [[#analysis-in-the-depth-domain][analysis in the depth domain]]
    - [[#analysis-in-the-time-domain][analysis in the time domain]]
    - [[#overall-variable-tie-points][overall variable tie-points]]
    - [[#waiting-for-grayscale-log-in-email][waiting for grayscale log in email]]
...
#+begin_src R :results none
  ...
  # load the CretaceousConstraints development package
  devtools::load_all()
  # set ggplot theme
  # very minimalist
  theme_set(theme_bw() +
...
other attached packages:
 [1] CretaceousConstraints_0.0.0.9000 testthat_3.2.3
 [3] furrr_0.3.1                      future_1.40.0
 [5] profvis_0.4.0                    assertr_3.0.1
 [7] patchwork_1.3.0                  lubridate_1.9.4
 [9] forcats_1.0.0                    stringr_1.5.1
[11] dplyr_1.1.4                      purrr_1.0.4
[13] readr_2.1.5                      tidyr_1.3.1
[15] tibble_3.2.1                     ggplot2_3.5.2
[17] tidyverse_2.0.0

loaded via a namespace (and not attached):
 [1] tidyselect_1.2.1   viridisLite_0.4.2  farver_2.1.2
 [4] astrochron_1.5     fields_16.3.1      palinsol_1.0
 [7] fastmap_1.2.0      promises_1.3.2     rpart_4.1.24
[10] digest_0.6.37      dotCall64_1.2      timechange_0.3.0
[13] mime_0.13          lifecycle_1.0.4    cluster_2.1.8.1
[16] ellipsis_0.3.2     magrittr_2.0.3     compiler_4.5.0
[19] rlang_1.1.6        Hmisc_5.2-3        tools_4.5.0
[22] yaml_2.3.10        data.table_1.17.0  knitr_1.50
[25] htmlwidgets_1.6.4  pkgbuild_1.4.7     RColorBrewer_1.1-3
[28] pkgload_1.4.0      miniUI_0.1.2       foreign_0.8-90
[31] withr_3.0.2        desc_1.4.3         nnet_7.3-20
[34] grid_4.5.0         urlchecker_1.0.1   colorspace_2.1-1
[37] xtable_1.8-4       globals_0.17.0     scales_1.4.0
[40] iterators_1.0.14   cli_3.6.5          rmarkdown_2.29
[43] generics_0.1.3     remotes_2.5.0      rstudioapi_0.17.1
[46] tzdb_0.5.0         IDPmisc_1.1.21     sessioninfo_1.2.3
[49] cachem_1.1.0       maps_3.4.2.1       parallel_4.5.0
[52] base64enc_0.1-3    vctrs_0.6.5        devtools_2.4.5
[55] hms_1.1.3          htmlTable_2.4.3    Formula_1.2-5
[58] listenv_0.9.1      foreach_1.5.2      glue_1.8.0
[61] parallelly_1.43.0  spam_2.11-1        multitaper_1.0-17
[64] codetools_0.2-20   stringi_1.8.7      gtable_0.3.6
[67] later_1.4.2        pillar_1.10.2      brio_1.1.5
[70] htmltools_0.5.8.1  R6_2.6.1           doParallel_1.0.17
[73] rprojroot_2.0.4    evaluate_1.0.3     shiny_1.10.0
[76] lattice_0.22-6     backports_1.5.0    memoise_2.0.1
[79] renv_1.1.4         httpuv_1.6.16      Rcpp_1.0.14
[82] checkmate_2.3.2    gridExtra_2.3      xfun_0.52
...
#+RESULTS:
: Error in `mutate()`:
: ℹ In argument: `age = -time`.
: Caused by error in `-time`:
...
Load the saved file, then process it further.
#+begin_src R
  ZB20b <- snvecR::get_solution("ZB20b") |>
    mutate(age = -time) |>
    select(age, ecc) |>
    filter(age >= 56000 & age <= 80000) |>
    mutate(scl = scale(ecc)[, 1]) |>
...
I have made the datasets that we don't look at a ~COMMENT~ headline, so I'm hoping GitHub will not render them. If you want to see all my notes, just open up the org file in any text editor.

** [#C] COMMENT IODP Leg 208 Site 1262
:PROPERTIES:
...
** [#C] COMMENT IODP Leg 198 Site 1209
:PROPERTIES:
...
** COMMENT 1209 older part
:PROPERTIES:
:CREATED:  [2024-07-09 Tue 15:29]
:END:
Thomas Westerhold told me at CIP2.0 that this record is much more impressive

from [cite:@Kim2022]
#+begin_src R
  ## dat <- pangaear::pg_data("10.1594/PANGAEA.951108")
  dat <- pangaear::pg_data("10.1594/PANGAEA.950898")[[1]]$data
#+end_src

From the SI of [cite:@Kim2022] we get
...
#+begin_src R
  agem_1209 <- tibble(n = 1:length(minima_405) - 1, strat_bot = minima_405) |>
    mutate(age_floating = seq(0, 405 * (n() - 1), by = 405))
#+end_src

#+begin_src R :results output graphics file :file imgs/1209_barium.png :width 800
  dat |>
    ggplot(aes(
      ## x = `Depth sed [m] (mbsf)`,
      ## x = `Depth comp r [rmcd]`,
      x = `Depth comp r [rmcd] (1209)`,
      ## x = `Tuned time [Ma] (405)`,
      y = `Ba count [#]`,
      colour = Event)) +
    geom_line() +
    geom_vline(xintercept = minima_405[[1]])
    ## spectral_analysis(method = "MTM ML96") |>
    ## plot_spectrum()
#+end_src

#+RESULTS:
[[file:imgs/1209_barium.png]]

#+begin_src R :results output graphics file :file imgs/1209_barium_spectrum.png :width 800
  dat |>
    select(depth = `Depth comp r [rmcd] (1209)`,
           value = `Ba count [#]`) |>
    filter(depth > minima_405[[1]]) |>
    filter(depth < max(minima_405)) |>
...
#+RESULTS:
[[file:imgs/1209_barium_spectrum.png]]

#+begin_src R :results output graphics file :file imgs/1209_barium_spectrum_their_age_model.png :width 800
  dat |>
    select(age = `Tuned time [Ma] (405)`,
           value = `Ba count [#]`,
           depth = `Depth comp r [rmcd] (1209)`) |>
    filter(depth > minima_405[[1]]) |>
    filter(depth < max(minima_405)) |>
    mutate(age = age * 1e3) |>
    spectral_analysis(x = age, y = value,
                      method = "MTM ML96",
                      ## method = "MTM PL",
                      ## method = "LOWSPEC",
                      detrend = TRUE) |>
    plot_spectrum(domain = "time")
#+end_src

#+RESULTS:
[[file:imgs/1209_barium_spectrum_their_age_model.png]]

at first the range of tiepoint variability was definitely too large
oh and I didn't double-check my freq frac

#+begin_src R
  tst_1209 |> write_rds("out/tst1209.rds")
#+end_src
...
#+begin_src R :results output graphics file :file imgs/1209_barium_matched.png :width 800
  tst_1209$matched |>
    ggplot(aes(x = age, y = ecc)) +
    scale_x_reverse() +
    ## geom_vline(aes(yintercept = kpg_age + age_slider)) +
    ## geom_line(aes(y = ecc_sln), colour = "gold") +
    geom_line(aes(y = value)) +
    geom_line(aes(y = `405 kyr`), colour = "red") +
    geom_line(aes(y = `100 kyr`), colour = "orange")
#+end_src

#+RESULTS:
[[file:imgs/1209_barium_matched.png]]

** COMMENT Contessa highway section
:PROPERTIES:
...
** [#A] COMMENT ODP Leg 208 Site 1267
:PROPERTIES:
...
*** [#B] COMMENT convert from mbsf and mcd to rmcd
:PROPERTIES:
...
*** COMMENT analyze MS data in depth domain (rmcd)
:PROPERTIES:
...
*** COMMENT plot the taner age model on top of the depth MS data
:PROPERTIES:
...
*** COMMENT apply the agemodel to the MS data
:PROPERTIES:
...
*** COMMENT analyze MS data in the time domain
:PROPERTIES:
...
#+end_src
*** COMMENT colour reflectance data from Janus database
:PROPERTIES:
...
** [#B] COMMENT IODP Exp 342 Site U1403A,B
:PROPERTIES:
...
#+begin_src R :exports both
  ...
  agem_sol <- agem_simple |>
    ## mutate(age = n * 405)
    mutate(sol = list(c(target_astronomical_solutions, "La11"))) |>
    unnest(cols = c(sol)) |>
    nest(.by = sol) |>
    # This is still wrong, strat = 0 = K/Pg boundary but in Batenburg
    ...
    mutate(age = case_when(sol == "ZB18a" ~
                           ...
                           sol == "La11" ~
                             sln_peaks |>
                             filter(sln == "La11", age >= 65.9 * 1e3 - 200) |>
                             arrange(age) |>
                             slice(1:14) |>
                             pull(age) |> list(),
                           TRUE ~ list(NA_real_))) |>
...
#+RESULTS:
: indexing 405_minima.csv [===============================================================================================================] 423.38MB/s, eta:  0s                                                                                                                                                                                                 Rows: 20 Columns: 5
: ── Column specification ──────────────────────────────────────────────────────
: Delimiter: ","
...
ℹ In argument: `window = fct_relevel(as_factor(window), c("rectangular",
  "gaussian", "taner"))`.
Caused by warning:
...
#+RESULTS:
: Error: object 'rolling_age_optim_old' not found
: Error: object 'rolling_age_optim_old' not found
: Warning message:
: In rm(cutoff) : object 'cutoff' not found
: Warning message:
: In rm(rolling_age_optim_old) : object 'rolling_age_optim_old' not found
: Error: object 'overall_sd_old' not found
: Error: object 'overall_best_old' not found
...
: max_age_slider, tiepoint_error, frac, roll, window)`
...
The following object is masked from ‘package:ggplot2’:
    ...
    annotate
# A tibble: 616 × 17
    proxy site     detrend_type depth_chunk     comb    s405  s100 sign_405 sign_100 sol   the_best         date        roll  frac window RMSD_start  RMSD
    <chr> <chr>    <fct>        <fct>           <fct>  <dbl> <dbl>    <dbl>    <dbl> <chr> <list>           <date>     <dbl> <dbl> <fct>       <dbl> <dbl>
  1 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.30  1.11
  2 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.35  1.16
  3 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.29  1.26
  4 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.44  1.14
  5 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.35  1.08
  6 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.36  1.23
  7 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.42  1.29
  8 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.25  1.08
  9 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.42  1.18
 10 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.31  1.16
 11 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.41  1.08
 12 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.38  1.09
 13 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.37  1.18
 14 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.38  1.23
 15 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.36  1.09
 16 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.14  0.997
 17 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.29  1.27
 18 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.37  1.28
 19 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.26  0.998
 20 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.36  1.31
 21 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.49  1.25
 22 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.32  1.01
 23 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.30  1.11
 24 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.04  0.936
 25 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.17  1.04
 26 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.31  1.18
 27 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.26  1.19
 28 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.40  1.11
 29 d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.35  1.18
 30 d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.35  1.20
 31 d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.44  1.21
 32 d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.43  1.21
 33 d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.40  1.21
 34 d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.46  1.17
 35 d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.47  1.19
 36 d13C  Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.25  1.06
 37 d13C  Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.34  1.12
 38 d13C  Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.40  1.10
 39 d13C  Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.35  1.12
 40 d13C  Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.30  1.05
 41 d13C  Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.42  1.09
 42 d13C  Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.37  1.12
 43 d13C  Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.23  1.04
 44 d13C  Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.22  0.998
 45 d13C  Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.22  1.10
 46 d13C  Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.20  1.01
 47 d13C  Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.06  1.01
 48 d13C  Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.29  1.09
 49 d13C  Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.31  1.12
 50 MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.40  1.18
 51 MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.33  1.11
 52 MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.30  1.17
 53 MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.39  1.27
 54 MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.38  1.22
 55 MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.28  1.18
 56 MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.25  1.11
 57 MS    Zumaia   lin_scl_med  depth < 109.26  1:1     1     1           1        1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.41  1.16
 58 MS    Zumaia   lin_scl_med  depth < 109.26  1:1     1     1           1        1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.19  1.12
 59 MS    Zumaia   lin_scl_med  depth < 109.26  1:1     1     1           1        1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.30  1.12
 60 MS    Zumaia   lin_scl_med  depth < 109.26  1:1     1     1           1        1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.32  1.18
 61 MS    Zumaia   lin_scl_med  depth < 109.26  1:1     1     1           1        1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.37  1.25
 62 MS    Zumaia   lin_scl_med  depth < 109.26  1:1     1     1           1        1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.30  1.17
 63 MS    Zumaia   lin_scl_med  depth < 109.26  1:1     1     1           1        1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.24  1.07
 64 MS    Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1           1        1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.29  1.21
 65 MS    Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1           1        1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.06  0.979
 66 MS    Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1           1        1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.36  1.24
 67 MS    Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1           1        1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.24  1.23
 68 MS    Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1           1        1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.15  1.12
 69 MS    Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1           1        1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.33  1.23
 70 MS    Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1           1        1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.30  1.21
 71 MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.31  1.08
 72 MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.44  1.11
 73 MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       0.900 0.857
 74 MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.12  0.957
 75 MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.37  1.21
 76 MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.04  0.947
 77 MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.19  0.961
 78 Lstar Zumaia   scl          full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.35  1.21
 79 Lstar Zumaia   scl          full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.40  1.22
 80 Lstar Zumaia   scl          full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.37  1.29
 81 Lstar Zumaia   scl          full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.49  1.37
 82 Lstar Zumaia   scl          full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.40  1.20
 83 Lstar Zumaia   scl          full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.43  1.31
 84 Lstar Zumaia   scl          full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.46  1.30
 85 Lstar Zumaia   scl          depth < 109.26  1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.36  1.23
 86 Lstar Zumaia   scl          depth < 109.26  1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.52  1.39
 87 Lstar Zumaia   scl          depth < 109.26  1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.41  1.27
 88 Lstar Zumaia   scl          depth < 109.26  1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.49  1.21
 89 Lstar Zumaia   scl          depth < 109.26  1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.46  1.22
 90 Lstar Zumaia   scl          depth < 109.26  1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.45  1.31
 91 Lstar Zumaia   scl          depth < 109.26  1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.49  1.29
 92 Lstar Zumaia   scl          depth >= 109.26 1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.29  1.16
 93 Lstar Zumaia   scl          depth >= 109.26 1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.17  1.09
 94 Lstar Zumaia   scl          depth >= 109.26 1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.31  1.30
 95 Lstar Zumaia   scl          depth >= 109.26 1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.33  1.28
 96 Lstar Zumaia   scl          depth >= 109.26 1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.31  1.17
 97 Lstar Zumaia   scl          depth >= 109.26 1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.38  1.31
 98 Lstar Zumaia   scl          depth >= 109.26 1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.47  1.31
 99 Lstar Sopelana scl          full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.35  1.07
100 Lstar Sopelana scl          full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.31  1.15
101 Lstar Sopelana scl          full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.08  0.940
102 Lstar Sopelana scl          full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-21 1e 10  0.3  taner       1.18  1.02
103 Lstar Sopelana scl          full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-21 1e 10  0.3  taner       1.31  1.20
104 Lstar Sopelana scl          full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-21 1e 10  0.3  taner       1.27  1.15
105 Lstar Sopelana scl          full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-21 1e 10  0.3  taner       1.42  1.11
106 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-27 1e  3  0.3  taner       1.32  1.13
107 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-27 1e  3  0.3  taner       1.39  1.22
108 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-27 1e  3  0.3  taner       1.32  1.27
109 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-27 1e  3  0.3  taner       1.46  1.28
110 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-27 1e  3  0.3  taner       1.38  1.17
111 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-27 1e  3  0.3  taner       1.38  1.27
112 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-27 1e  3  0.3  taner       1.43  1.33
113 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-27 1e  3  0.3  taner       1.26  1.09
114 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-27 1e  3  0.3  taner       1.40  1.21
115 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-27 1e  3  0.3  taner       1.33  1.17
116 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-27 1e  3  0.3  taner       1.42  1.12
117 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-27 1e  3  0.3  taner       1.39  1.10
118 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-27 1e  3  0.3  taner       1.37  1.20
119 Lstar Zumaia   lin_scl_med  depth < 109.26  1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-27 1e  3  0.3  taner       1.38  1.26
120 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-27 1e  3  0.3  taner       1.42  1.19
121 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-27 1e  3  0.3  taner       1.25  1.12
122 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-27 1e  3  0.3  taner       1.32  1.30
123 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-27 1e  3  0.3  taner       1.40  1.35
124 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-27 1e  3  0.3  taner       1.35  1.10
125 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-27 1e  3  0.3  taner       1.38  1.34
126 Lstar Zumaia   lin_scl_med  depth >= 109.26 1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-27 1e  3  0.3  taner       1.51  1.26
127 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-27 1e  3  0.3  taner       1.37  1.12
128 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-27 1e  3  0.3  taner       1.33  1.12
129 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-27 1e  3  0.3  taner       1.08  0.975
130 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-27 1e  3  0.3  taner       1.21  1.08
131 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-27 1e  3  0.3  taner       1.33  1.23
132 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-27 1e  3  0.3  taner       1.31  1.13
133 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-27 1e  3  0.3  taner       1.46  1.13
134 Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-27 1e 10  0.3  taner       1.29  1.10
135 Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-27 1e 10  0.3  taner       1.34  1.15
136 Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-27 1e 10  0.3  taner       1.28  1.22
137 Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-27 1e 10  0.3  taner       1.40  1.12
138 Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-27 1e 10  0.3  taner       1.33  1.10
139 Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-27 1e 10  0.3  taner       1.35  1.22
140 Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-27 1e 10  0.3  taner       1.40  1.29
141 Lstar Sopelana lin_scl_fine full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-27 1e 10  0.3  taner       1.32  1.01
142 Lstar Sopelana lin_scl_fine full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-27 1e 10  0.3  taner       1.30  1.11
143 Lstar Sopelana lin_scl_fine full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-27 1e 10  0.3  taner       1.04  0.936
144 Lstar Sopelana lin_scl_fine full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-27 1e 10  0.3  taner       1.17  1.04
145 Lstar Sopelana lin_scl_fine full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-27 1e 10  0.3  taner       1.31  1.18
146 Lstar Sopelana lin_scl_fine full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-27 1e 10  0.3  taner       1.26  1.19
147 Lstar Sopelana lin_scl_fine full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-27 1e 10  0.3  taner       1.40  1.11
148 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-27 1e  6  0.3  taner       1.30  1.10
149 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-27 1e  6  0.3  taner       1.35  1.17
150 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-27 1e  6  0.3  taner       1.29  1.25
151 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-27 1e  6  0.3  taner       1.44  1.15
152 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-27 1e  6  0.3  taner       1.35  1.10
153 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-27 1e  6  0.3  taner       1.36  1.24
154 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-27 1e  6  0.3  taner       1.41  1.29
155 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-27 1e  6  0.3  taner       1.32  1.00
156 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-27 1e  6  0.3  taner       1.29  1.09
157 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-27 1e  6  0.3  taner       1.04  0.936
158 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-27 1e  6  0.3  taner       1.17  1.03
159 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-27 1e  6  0.3  taner       1.30  1.17
160 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-27 1e  6  0.3  taner       1.26  1.10
161 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-27 1e  6  0.3  taner       1.41  1.11
162 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 La10b <named list [4]> 2024-03-27 1e 12  0.3  taner       1.30  1.11
163 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 La10c <named list [4]> 2024-03-27 1e 12  0.3  taner       1.35  1.16
164 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB18a <named list [4]> 2024-03-27 1e 12  0.3  taner       1.29  1.26
165 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20a <named list [4]> 2024-03-27 1e 12  0.3  taner       1.44  1.17
166 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20b <named list [4]> 2024-03-27 1e 12  0.3  taner       1.35  1.09
167 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20c <named list [4]> 2024-03-27 1e 12  0.3  taner       1.36  1.25
168 Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -1       -1 ZB20d <named list [4]> 2024-03-27 1e 12  0.3  taner       1.42  1.30
169 Lstar Sopelana lin_scl_med  full record     1:1     1     1          -1       -1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 12  0.3  taner       1.32  1.02
[90m170[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 12  0.3  taner       1.31  1.12
[90m171[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 12  0.3  taner       1.04  0.939
[90m172[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 12  0.3  taner       1.18  1.05
[90m173[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 12  0.3  taner       1.31  1.19
[90m174[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 12  0.3  taner       1.26  1.19
[90m175[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 12  0.3  taner       1.41  1.12
[90m176[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.30  1.10
[90m177[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.35  1.16
[90m178[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.29  1.25
[90m179[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.44  1.15
[90m180[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.35  1.09
[90m181[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.36  1.23
[90m182[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.41  1.29
[90m183[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.32  1.01
[90m184[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.29  1.10
[90m185[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.04  0.935
[90m186[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.17  1.03
[90m187[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.30  1.17
[90m188[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.26  1.19
[90m189[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m  8  0.3  taner       1.40  1.11
[90m190[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.31  1.14
[90m191[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.38  1.17
[90m192[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.30  1.26
[90m193[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.46  1.28
[90m194[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.36  1.11
[90m195[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.37  1.27
[90m196[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.44  1.32
[90m197[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.34  1.06
[90m198[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.34  1.17
[90m199[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.05  0.975
[90m200[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.20  1.09
[90m201[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.30  1.23
[90m202[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.27  1.21
[90m203[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m100  0.3  taner       1.42  1.13
[90m204[39m Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.29  1.10
[90m205[39m Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.34  1.15
[90m206[39m Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.28  1.22
[90m207[39m Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.40  1.12
[90m208[39m Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.33  1.10
[90m209[39m Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.35  1.22
[90m210[39m Lstar Zumaia   lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.40  1.29
[90m211[39m Lstar Sopelana lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.32  1.01
[90m212[39m Lstar Sopelana lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.30  1.11
[90m213[39m Lstar Sopelana lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.04  0.936
[90m214[39m Lstar Sopelana lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.17  1.04
[90m215[39m Lstar Sopelana lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.31  1.18
[90m216[39m Lstar Sopelana lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.26  1.19
[90m217[39m Lstar Sopelana lin_scl_fine full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.3  taner       1.40  1.11
[90m218[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.33  1.13
[90m219[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.33  1.21
[90m220[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.33  1.24
[90m221[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.40  1.30
[90m222[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.34  1.23
[90m223[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.36  1.28
[90m224[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.42  1.33
[90m225[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.39  1.21
[90m226[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.17  1.03
[90m227[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.07  0.961
[90m228[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.07  0.905
[90m229[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.35  1.16
[90m230[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.32  1.13
[90m231[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.1  taner       1.35  1.21
[90m232[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.29  1.03
[90m233[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.31  1.14
[90m234[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.26  1.18
[90m235[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.40  1.23
[90m236[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.33  1.07
[90m237[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.33  1.23
[90m238[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.37  1.25
[90m239[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.26  0.896
[90m240[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.17  0.989
[90m241[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       0.954 0.895
[90m242[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.09  0.882
[90m243[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.24  1.03
[90m244[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.19  1.05
[90m245[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.2  taner       1.32  1.08
[90m246[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.28  1.06
[90m247[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.33  1.14
[90m248[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.27  1.22
[90m249[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.42  1.12
[90m250[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.33  1.07
[90m251[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.34  1.20
[90m252[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.39  1.27
[90m253[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.29  0.950
[90m254[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.24  1.05
[90m255[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       0.986 0.908
[90m256[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.12  0.954
[90m257[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.27  1.11
[90m258[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.22  1.16
[90m259[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.25 taner       1.36  1.11
[90m260[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.28  1.04
[90m261[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.32  1.13
[90m262[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.26  1.20
[90m263[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.41  1.23
[90m264[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.32  1.06
[90m265[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.34  1.19
[90m266[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.38  1.25
[90m267[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.27  0.912
[90m268[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.20  1.02
[90m269[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       0.962 0.894
[90m270[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.10  0.906
[90m271[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.26  1.06
[90m272[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.20  1.08
[90m273[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.22 taner       1.34  1.09
[90m274[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.28  1.04
[90m275[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.32  1.13
[90m276[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.26  1.20
[90m277[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.41  1.23
[90m278[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.32  1.07
[90m279[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.34  1.20
[90m280[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.38  1.26
[90m281[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.28  0.924
[90m282[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.21  1.03
[90m283[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       0.969 0.898
[90m284[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.10  0.921
[90m285[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.26  1.08
[90m286[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.21  1.14
[90m287[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.23 taner       1.34  1.10
[90m288[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.28  1.05
[90m289[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.32  1.13
[90m290[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.27  1.21
[90m291[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.41  1.11
[90m292[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.32  1.06
[90m293[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.34  1.21
[90m294[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.39  1.26
[90m295[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.28  0.936
[90m296[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.22  1.05
[90m297[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       0.977 0.903
[90m298[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.11  0.937
[90m299[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.27  1.09
[90m300[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.21  1.15
[90m301[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-27 1[90me[39m 10  0.24 taner       1.35  1.10
[90m302[39m d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.34  1.18
[90m303[39m d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.32  1.18
[90m304[39m d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.43  1.18
[90m305[39m d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.40  1.20
[90m306[39m d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.39  1.21
[90m307[39m d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.46  1.15
[90m308[39m d13C  Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.45  1.19
[90m309[39m MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.38  1.15
[90m310[39m MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.30  1.04
[90m311[39m MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.27  1.13
[90m312[39m MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.37  1.24
[90m313[39m MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.36  1.19
[90m314[39m MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.26  1.15
[90m315[39m MS    Zumaia   lin_scl_med  full record     1:1     1     1           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.22  1.07
[90m316[39m MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.30  1.06
[90m317[39m MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.42  1.07
[90m318[39m MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.868 0.834
[90m319[39m MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.11  0.929
[90m320[39m MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.37  1.20
[90m321[39m MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.01  0.922
[90m322[39m MS    Sopelana lin_scl_med  full record     1:1     1     1           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.16  0.918
[90m323[39m d13C  Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.979 0.907
[90m324[39m d13C  Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.988 0.918
[90m325[39m d13C  Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.04  0.969
[90m326[39m d13C  Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.01  0.951
[90m327[39m d13C  Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.974 0.903
[90m328[39m d13C  Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.07  1.01
[90m329[39m d13C  Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.09  1.04
[90m330[39m d13C  Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.908
[90m331[39m d13C  Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.998 0.942
[90m332[39m d13C  Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.07  0.932
[90m333[39m d13C  Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.06  0.944
[90m334[39m d13C  Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.909
[90m335[39m d13C  Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.10  0.943
[90m336[39m d13C  Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.12  1.02
[90m337[39m d13C  Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.09  0.953
[90m338[39m d13C  Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.06  0.954
[90m339[39m d13C  Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.15  0.961
[90m340[39m d13C  Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.15  1.05
[90m341[39m d13C  Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.11  0.970
[90m342[39m d13C  Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.18  0.952
[90m343[39m d13C  Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.19  1.00
[90m344[39m d13C  Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.20  1.05
[90m345[39m d13C  Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.17  1.05
[90m346[39m d13C  Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.28  1.05
[90m347[39m d13C  Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.26  1.08
[90m348[39m d13C  Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  1.07
[90m349[39m d13C  Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.30  1.02
[90m350[39m d13C  Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.30  1.05
[90m351[39m d13C  Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.20  1.08
[90m352[39m d13C  Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.23  1.07
[90m353[39m d13C  Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.31  1.12
[90m354[39m d13C  Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.27  1.06
[90m355[39m d13C  Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.26  1.06
[90m356[39m d13C  Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.35  1.08
[90m357[39m d13C  Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.31  0.999
[90m358[39m d13C  Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.20  1.06
[90m359[39m d13C  Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.22  1.05
[90m360[39m d13C  Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.31  1.04
[90m361[39m d13C  Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.27  1.05
[90m362[39m d13C  Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.26  1.05
[90m363[39m d13C  Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.35  1.07
[90m364[39m d13C  Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.31  0.984
[90m365[39m d13C  Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.25  1.12
[90m366[39m d13C  Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.25  1.09
[90m367[39m d13C  Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.35  1.09
[90m368[39m d13C  Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.32  1.11
[90m369[39m d13C  Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.30  1.12
[90m370[39m d13C  Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.38  1.05
[90m371[39m d13C  Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.36  1.07
[90m372[39m d13C  Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.20  1.07
[90m373[39m d13C  Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.27  1.11
[90m374[39m d13C  Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.23  1.04
[90m375[39m d13C  Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.29  1.17
[90m376[39m d13C  Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.27  1.14
[90m377[39m d13C  Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.26  1.10
[90m378[39m d13C  Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.29  1.05
[90m379[39m MS    Zumaia   lin_scl_med  full record     1:0     1     0           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.967 0.892
[90m380[39m MS    Zumaia   lin_scl_med  full record     1:0     1     0           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.964 0.905
[90m381[39m MS    Zumaia   lin_scl_med  full record     1:0     1     0           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.03  0.961
[90m382[39m MS    Zumaia   lin_scl_med  full record     1:0     1     0           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.07  0.986
[90m383[39m MS    Zumaia   lin_scl_med  full record     1:0     1     0           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.989 0.898
[90m384[39m MS    Zumaia   lin_scl_med  full record     1:0     1     0           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.07  0.988
[90m385[39m MS    Zumaia   lin_scl_med  full record     1:0     1     0           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.10  1.04
[90m386[39m MS    Zumaia   lin_scl_med  full record     1:0.25  1     0.25        1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.00  0.865
[90m387[39m MS    Zumaia   lin_scl_med  full record     1:0.25  1     0.25        1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.974 0.891
[90m388[39m MS    Zumaia   lin_scl_med  full record     1:0.25  1     0.25        1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.03  0.929
[90m389[39m MS    Zumaia   lin_scl_med  full record     1:0.25  1     0.25        1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.10  1.03
[90m390[39m MS    Zumaia   lin_scl_med  full record     1:0.25  1     0.25        1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.900
[90m391[39m MS    Zumaia   lin_scl_med  full record     1:0.25  1     0.25        1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.06  0.974
[90m392[39m MS    Zumaia   lin_scl_med  full record     1:0.25  1     0.25        1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.07  1.00
[90m393[39m MS    Zumaia   lin_scl_med  full record     1:0.5   1     0.5         1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.09  0.911
[90m394[39m MS    Zumaia   lin_scl_med  full record     1:0.5   1     0.5         1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.04  0.890
[90m395[39m MS    Zumaia   lin_scl_med  full record     1:0.5   1     0.5         1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.06  0.956
[90m396[39m MS    Zumaia   lin_scl_med  full record     1:0.5   1     0.5         1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.14  1.05
[90m397[39m MS    Zumaia   lin_scl_med  full record     1:0.5   1     0.5         1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.09  0.948
[90m398[39m MS    Zumaia   lin_scl_med  full record     1:0.5   1     0.5         1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.08  0.996
[90m399[39m MS    Zumaia   lin_scl_med  full record     1:0.5   1     0.5         1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.07  0.964
[90m400[39m MS    Zumaia   lin_scl_med  full record     1:0.75  1     0.75        1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.22  1.01
[90m401[39m MS    Zumaia   lin_scl_med  full record     1:0.75  1     0.75        1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.15  0.942
[90m402[39m MS    Zumaia   lin_scl_med  full record     1:0.75  1     0.75        1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.14  1.03
[90m403[39m MS    Zumaia   lin_scl_med  full record     1:0.75  1     0.75        1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  1.14
[90m404[39m MS    Zumaia   lin_scl_med  full record     1:0.75  1     0.75        1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.21  1.04
[90m405[39m MS    Zumaia   lin_scl_med  full record     1:0.75  1     0.75        1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.14  1.05
[90m406[39m MS    Zumaia   lin_scl_med  full record     1:0.75  1     0.75        1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.12  0.987
[90m407[39m MS    Zumaia   lin_scl_med  full record     0.25:1  0.25  1           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.29  1.04
[90m408[39m MS    Zumaia   lin_scl_med  full record     0.25:1  0.25  1           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.22  0.946
[90m409[39m MS    Zumaia   lin_scl_med  full record     0.25:1  0.25  1           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.16  0.997
[90m410[39m MS    Zumaia   lin_scl_med  full record     0.25:1  0.25  1           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.22  1.05
[90m411[39m MS    Zumaia   lin_scl_med  full record     0.25:1  0.25  1           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.25  1.02
[90m412[39m MS    Zumaia   lin_scl_med  full record     0.25:1  0.25  1           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.11  0.981
[90m413[39m MS    Zumaia   lin_scl_med  full record     0.25:1  0.25  1           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.05  0.901
[90m414[39m MS    Zumaia   lin_scl_med  full record     0.5:1   0.5   1           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.27  1.02
[90m415[39m MS    Zumaia   lin_scl_med  full record     0.5:1   0.5   1           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.20  0.915
[90m416[39m MS    Zumaia   lin_scl_med  full record     0.5:1   0.5   1           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.14  0.992
[90m417[39m MS    Zumaia   lin_scl_med  full record     0.5:1   0.5   1           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.22  1.08
[90m418[39m MS    Zumaia   lin_scl_med  full record     0.5:1   0.5   1           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  1.01
[90m419[39m MS    Zumaia   lin_scl_med  full record     0.5:1   0.5   1           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.11  0.982
[90m420[39m MS    Zumaia   lin_scl_med  full record     0.5:1   0.5   1           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.05  0.897
[90m421[39m MS    Zumaia   lin_scl_med  full record     0.75:1  0.75  1           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.31  1.06
[90m422[39m MS    Zumaia   lin_scl_med  full record     0.75:1  0.75  1           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.22  0.968
[90m423[39m MS    Zumaia   lin_scl_med  full record     0.75:1  0.75  1           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.18  1.04
[90m424[39m MS    Zumaia   lin_scl_med  full record     0.75:1  0.75  1           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.27  1.14
[90m425[39m MS    Zumaia   lin_scl_med  full record     0.75:1  0.75  1           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.28  1.10
[90m426[39m MS    Zumaia   lin_scl_med  full record     0.75:1  0.75  1           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.16  1.04
[90m427[39m MS    Zumaia   lin_scl_med  full record     0.75:1  0.75  1           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.11  0.964
[90m428[39m MS    Zumaia   lin_scl_med  full record     0:1     0     1           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.30  1.11
[90m429[39m MS    Zumaia   lin_scl_med  full record     0:1     0     1           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  1.02
[90m430[39m MS    Zumaia   lin_scl_med  full record     0:1     0     1           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.22  1.05
[90m431[39m MS    Zumaia   lin_scl_med  full record     0:1     0     1           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  1.05
[90m432[39m MS    Zumaia   lin_scl_med  full record     0:1     0     1           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.30  1.12
[90m433[39m MS    Zumaia   lin_scl_med  full record     0:1     0     1           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.17  1.04
[90m434[39m MS    Zumaia   lin_scl_med  full record     0:1     0     1           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.11  0.976
[90m435[39m Lstar Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.945 0.863
[90m436[39m Lstar Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.962 0.889
[90m437[39m Lstar Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.958
[90m438[39m Lstar Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.01  0.943
[90m439[39m Lstar Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.966 0.882
[90m440[39m Lstar Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.06  1.00
[90m441[39m Lstar Zumaia   lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.09  1.04
[90m442[39m Lstar Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.946 0.833
[90m443[39m Lstar Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.973 0.869
[90m444[39m Lstar Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.00  0.960
[90m445[39m Lstar Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.07  0.900
[90m446[39m Lstar Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.999 0.836
[90m447[39m Lstar Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.05  0.965
[90m448[39m Lstar Zumaia   lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.10  1.02
[90m449[39m Lstar Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.01  0.836
[90m450[39m Lstar Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.04  0.896
[90m451[39m Lstar Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.04  0.993
[90m452[39m Lstar Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.15  0.953
[90m453[39m Lstar Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.07  0.862
[90m454[39m Lstar Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.10  1.02
[90m455[39m Lstar Zumaia   lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.15  1.07
[90m456[39m Lstar Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.13  0.920
[90m457[39m Lstar Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.17  0.993
[90m458[39m Lstar Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.13  1.07
[90m459[39m Lstar Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.27  1.02
[90m460[39m Lstar Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.18  0.922
[90m461[39m Lstar Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.20  1.09
[90m462[39m Lstar Zumaia   lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.25  1.14
[90m463[39m Lstar Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.21  0.964
[90m464[39m Lstar Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.25  1.10
[90m465[39m Lstar Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.18  1.08
[90m466[39m Lstar Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  1.09
[90m467[39m Lstar Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.21  1.00
[90m468[39m Lstar Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.25  1.14
[90m469[39m Lstar Zumaia   lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.27  1.18
[90m470[39m Lstar Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.18  0.959
[90m471[39m Lstar Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.23  1.05
[90m472[39m Lstar Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.16  1.09
[90m473[39m Lstar Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.25  1.10
[90m474[39m Lstar Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.20  0.961
[90m475[39m Lstar Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.23  1.11
[90m476[39m Lstar Zumaia   lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.26  1.14
[90m477[39m Lstar Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.21  1.00
[90m478[39m Lstar Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.25  1.06
[90m479[39m Lstar Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.19  1.11
[90m480[39m Lstar Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.32  1.14
[90m481[39m Lstar Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  1.01
[90m482[39m Lstar Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.26  1.13
[90m483[39m Lstar Zumaia   lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.31  1.17
[90m484[39m Lstar Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.28  1.06
[90m485[39m Lstar Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  1.12
[90m486[39m Lstar Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.25  1.14
[90m487[39m Lstar Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  1.12
[90m488[39m Lstar Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.25  1.17
[90m489[39m Lstar Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.31  1.16
[90m490[39m Lstar Zumaia   lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.26  1.12
[90m491[39m MS    Sopelana lin_scl_med  full record     1:0     1     0           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.14  1.13
[90m492[39m MS    Sopelana lin_scl_med  full record     1:0     1     0           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.974 0.935
[90m493[39m MS    Sopelana lin_scl_med  full record     1:0     1     0           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.834 0.783
[90m494[39m MS    Sopelana lin_scl_med  full record     1:0     1     0           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.872 0.826
[90m495[39m MS    Sopelana lin_scl_med  full record     1:0     1     0           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.996 0.976
[90m496[39m MS    Sopelana lin_scl_med  full record     1:0     1     0           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.05  1.03
[90m497[39m MS    Sopelana lin_scl_med  full record     1:0     1     0           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.12  1.10
[90m498[39m MS    Sopelana lin_scl_med  full record     1:0.25  1     0.25        1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.15  1.07
[90m499[39m MS    Sopelana lin_scl_med  full record     1:0.25  1     0.25        1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.871
[90m500[39m MS    Sopelana lin_scl_med  full record     1:0.25  1     0.25        1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.730 0.695
[90m501[39m MS    Sopelana lin_scl_med  full record     1:0.25  1     0.25        1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.877 0.802
[90m502[39m MS    Sopelana lin_scl_med  full record     1:0.25  1     0.25        1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.970
[90m503[39m MS    Sopelana lin_scl_med  full record     1:0.25  1     0.25        1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.948 0.935
[90m504[39m MS    Sopelana lin_scl_med  full record     1:0.25  1     0.25        1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.04  0.983
[90m505[39m MS    Sopelana lin_scl_med  full record     1:0.5   1     0.5         1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.16  1.01
[90m506[39m MS    Sopelana lin_scl_med  full record     1:0.5   1     0.5         1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.12  0.883
[90m507[39m MS    Sopelana lin_scl_med  full record     1:0.5   1     0.5         1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.694 0.671
[90m508[39m MS    Sopelana lin_scl_med  full record     1:0.5   1     0.5         1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.901 0.779
[90m509[39m MS    Sopelana lin_scl_med  full record     1:0.5   1     0.5         1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.09  1.03
[90m510[39m MS    Sopelana lin_scl_med  full record     1:0.5   1     0.5         1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.901 0.871
[90m511[39m MS    Sopelana lin_scl_med  full record     1:0.5   1     0.5         1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.895
[90m512[39m MS    Sopelana lin_scl_med  full record     1:0.75  1     0.75        1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.20  1.01
[90m513[39m MS    Sopelana lin_scl_med  full record     1:0.75  1     0.75        1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.26  0.960
[90m514[39m MS    Sopelana lin_scl_med  full record     1:0.75  1     0.75        1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.745 0.716
[90m515[39m MS    Sopelana lin_scl_med  full record     1:0.75  1     0.75        1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.980 0.809
[90m516[39m MS    Sopelana lin_scl_med  full record     1:0.75  1     0.75        1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.22  1.09
[90m517[39m MS    Sopelana lin_scl_med  full record     1:0.75  1     0.75        1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.922 0.852
[90m518[39m MS    Sopelana lin_scl_med  full record     1:0.75  1     0.75        1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.06  0.872
[90m519[39m MS    Sopelana lin_scl_med  full record     0.25:1  0.25  1           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.07  0.762
[90m520[39m MS    Sopelana lin_scl_med  full record     0.25:1  0.25  1           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.29  1.01
[90m521[39m MS    Sopelana lin_scl_med  full record     0.25:1  0.25  1           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.869 0.824
[90m522[39m MS    Sopelana lin_scl_med  full record     0.25:1  0.25  1           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.04  0.905
[90m523[39m MS    Sopelana lin_scl_med  full record     0.25:1  0.25  1           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.31  1.05
[90m524[39m MS    Sopelana lin_scl_med  full record     0.25:1  0.25  1           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.917 0.823
[90m525[39m MS    Sopelana lin_scl_med  full record     0.25:1  0.25  1           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.04  0.758
[90m526[39m MS    Sopelana lin_scl_med  full record     0.5:1   0.5   1           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.10  0.824
[90m527[39m MS    Sopelana lin_scl_med  full record     0.5:1   0.5   1           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.31  1.04
[90m528[39m MS    Sopelana lin_scl_med  full record     0.5:1   0.5   1           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.794 0.753
[90m529[39m MS    Sopelana lin_scl_med  full record     0.5:1   0.5   1           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.01  0.844
[90m530[39m MS    Sopelana lin_scl_med  full record     0.5:1   0.5   1           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.29  1.06
[90m531[39m MS    Sopelana lin_scl_med  full record     0.5:1   0.5   1           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.879 0.802
[90m532[39m MS    Sopelana lin_scl_med  full record     0.5:1   0.5   1           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.735
[90m533[39m MS    Sopelana lin_scl_med  full record     0.75:1  0.75  1           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.17  0.920
[90m534[39m MS    Sopelana lin_scl_med  full record     0.75:1  0.75  1           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.35  1.09
[90m535[39m MS    Sopelana lin_scl_med  full record     0.75:1  0.75  1           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.794 0.754
[90m536[39m MS    Sopelana lin_scl_med  full record     0.75:1  0.75  1           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.03  0.854
[90m537[39m MS    Sopelana lin_scl_med  full record     0.75:1  0.75  1           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.31  1.09
[90m538[39m MS    Sopelana lin_scl_med  full record     0.75:1  0.75  1           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.911 0.819
[90m539[39m MS    Sopelana lin_scl_med  full record     0.75:1  0.75  1           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.06  0.793
[90m540[39m MS    Sopelana lin_scl_med  full record     0:1     0     1           1        1 La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.10  0.809
[90m541[39m MS    Sopelana lin_scl_med  full record     0:1     0     1           1        1 La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.28  1.17
[90m542[39m MS    Sopelana lin_scl_med  full record     0:1     0     1           1        1 ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.00  0.962
[90m543[39m MS    Sopelana lin_scl_med  full record     0:1     0     1           1        1 ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.14  1.02
[90m544[39m MS    Sopelana lin_scl_med  full record     0:1     0     1           1        1 ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.26  1.21
[90m545[39m MS    Sopelana lin_scl_med  full record     0:1     0     1           1        1 ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.939
[90m546[39m MS    Sopelana lin_scl_med  full record     0:1     0     1           1        1 ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.10  0.913
[90m547[39m Lstar Sopelana lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.15  1.11
[90m548[39m Lstar Sopelana lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.04  0.948
[90m549[39m Lstar Sopelana lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.812 0.772
[90m550[39m Lstar Sopelana lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.897 0.864
[90m551[39m Lstar Sopelana lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.992
[90m552[39m Lstar Sopelana lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.05  1.01
[90m553[39m Lstar Sopelana lin_scl_med  full record     1:0     1     0          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.13  1.10
[90m554[39m Lstar Sopelana lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.12  1.02
[90m555[39m Lstar Sopelana lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.926
[90m556[39m Lstar Sopelana lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.748 0.677
[90m557[39m Lstar Sopelana lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.962 0.836
[90m558[39m Lstar Sopelana lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.999 0.963
[90m559[39m Lstar Sopelana lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.03  0.933
[90m560[39m Lstar Sopelana lin_scl_med  full record     1:0.25  1     0.25       -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.12  1.01
[90m561[39m Lstar Sopelana lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.12  0.913
[90m562[39m Lstar Sopelana lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.04  0.908
[90m563[39m Lstar Sopelana lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.757 0.670
[90m564[39m Lstar Sopelana lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.964 0.808
[90m565[39m Lstar Sopelana lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.04  0.953
[90m566[39m Lstar Sopelana lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.04  0.945
[90m567[39m Lstar Sopelana lin_scl_med  full record     1:0.5   1     0.5        -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.16  0.966
[90m568[39m Lstar Sopelana lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.18  0.898
[90m569[39m Lstar Sopelana lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.12  0.953
[90m570[39m Lstar Sopelana lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.844 0.763
[90m571[39m Lstar Sopelana lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.849
[90m572[39m Lstar Sopelana lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.14  0.997
[90m573[39m Lstar Sopelana lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.11  1.00
[90m574[39m Lstar Sopelana lin_scl_med  full record     1:0.75  1     0.75       -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  1.01
[90m575[39m Lstar Sopelana lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.13  0.730
[90m576[39m Lstar Sopelana lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.09  0.899
[90m577[39m Lstar Sopelana lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.994 0.904
[90m578[39m Lstar Sopelana lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.977 0.887
[90m579[39m Lstar Sopelana lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.20  1.04
[90m580[39m Lstar Sopelana lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.12  0.928
[90m581[39m Lstar Sopelana lin_scl_med  full record     0.25:1  0.25  1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  0.914
[90m582[39m Lstar Sopelana lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.13  0.733
[90m583[39m Lstar Sopelana lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.09  0.899
[90m584[39m Lstar Sopelana lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.926 0.837
[90m585[39m Lstar Sopelana lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.968 0.852
[90m586[39m Lstar Sopelana lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.17  1.01
[90m587[39m Lstar Sopelana lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.10  0.924
[90m588[39m Lstar Sopelana lin_scl_med  full record     0.5:1   0.5   1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.23  0.922
[90m589[39m Lstar Sopelana lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.19  0.813
[90m590[39m Lstar Sopelana lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.14  0.942
[90m591[39m Lstar Sopelana lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       0.923 0.842
[90m592[39m Lstar Sopelana lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.02  0.864
[90m593[39m Lstar Sopelana lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.20  1.03
[90m594[39m Lstar Sopelana lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.13  1.05
[90m595[39m Lstar Sopelana lin_scl_med  full record     0.75:1  0.75  1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.27  1.01
[90m596[39m Lstar Sopelana lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.14  0.878
[90m597[39m Lstar Sopelana lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.15  0.979
[90m598[39m Lstar Sopelana lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.11  1.03
[90m599[39m Lstar Sopelana lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.05  0.993
[90m600[39m Lstar Sopelana lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.24  1.07
[90m601[39m Lstar Sopelana lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.19  0.984
[90m602[39m Lstar Sopelana lin_scl_med  full record     0:1     0     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m 10  0.25 taner       1.26  0.823
[90m603[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.30  1.10
[90m604[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.36  1.19
[90m605[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.30  1.25
[90m606[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.44  1.28
[90m607[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.35  1.12
[90m608[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.36  1.26
[90m609[39m Lstar Zumaia   lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.42  1.33
[90m610[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10b [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.34  1.10
[90m611[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m La10c [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.26  1.17
[90m612[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB18a [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.05  0.960
[90m613[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20a [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.17  1.04
[90m614[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20b [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.31  1.20
[90m615[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20c [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.28  1.12
[90m616[39m Lstar Sopelana lin_scl_med  full record     1:1     1     1          -[31m1[39m       -[31m1[39m ZB20d [90m<named list [4]>[39m 2024-03-28 1[90me[39m  4  0.3  taner       1.42  1.10
[1m[33mError[39m in `best_age_optim[i, c(1:5, 10, 12:18)]`:[22m
[33m![39m Can't subset columns past the end.
[1m[22m[36mℹ[39m Location 18 doesn't exist.
[36mℹ[39m There are only 17 columns.
...
| ZB20d |   1.2 |  1.2 | 1.03 |
**** table of final age model
:PROPERTIES:
:CREATED:  [2024-09-17 Tue 15:21]
:END:
#+begin_src R :results value :colnames yes
  best_age_model <-
    overall_sd |>
    ...
    filter(sol == "ZB20a") |>
    ## filter(age_slider == )
      tidylog::distinct(s405, s100, sign_405, sign_100, window,
                        date, site,
                      .keep_all = TRUE) |>
    # still 2 sites remaining
    mutate(agem = map(the_best, "summary")) |>
    select(site, agem) |>
    unnest(agem) |>
    mutate(age = (kpg_age + age_slider + age_floating) ## / 1000
           ) |>
    # the caption needs:
    # input kpg age of 65900 ka
    # age slider of -6.4 kyr
    # what is the implied age of the KPg boundary???
    select(Ma405 = n, depth = strat_bot, offset = tie_err, site, age)

    ## glimpse()
  best_age_model |>
    left_join(agem_sol |>
              filter(sol == "La11") |>
              select(Ma405 = n, depth = strat_bot, age_La11 = age)) |>
    left_join(agem_sol |>
              filter(sol == "ZB20a") |>
              ## mutate(age = age / 1000) |>
              select(Ma405 = n, depth = strat_bot, age_ZB20a = age)) |>
    mutate(age_diff_La11 = age - age_La11) |>
    mutate(age_diff_ZB20a = age - age_ZB20a) |>
    ## summarize(diLa = mean(age_diff_La11), diZe = mean(age_diff_ZB20a))
    mutate(across(c(offset, age, age_La11, age_ZB20a,
                    age_diff_La11, age_diff_ZB20a), \(x) signif(x, 5)))
    ## glimpse()
#+end_src

#+RESULTS:
| Ma405 | depth | offset | site     | age_La11 | age_ZB20a |   age | age_diff_La11 | age_diff_ZB20a |
|-------+-------+--------+----------+----------+-----------+-------+---------------+----------------|
|     0 |     0 |   -1.2 | Zumaia   |    65966 |     65896 | 65894 |         -72.4 |           -2.4 |
|     1 |    16 |   -1.6 | Zumaia   |    66375 |     66290 | 66299 |         -76.4 |              9 |
|     2 |    32 |      0 | Zumaia   |    66784 |     66691 | 66704 |         -80.4 |           12.4 |
|     3 |    47 |   -0.8 | Zumaia   |    67190 |     67101 | 67109 |         -81.4 |            7.8 |
|     4 |    61 |    1.2 | Zumaia   |    67588 |     67512 | 67514 |         -74.4 |            1.6 |
|     5 |    76 |    1.6 | Zumaia   |    67984 |     67917 | 67919 |         -65.4 |            1.8 |
|     6 |    91 |    1.6 | Zumaia   |    68383 |     68315 | 68324 |         -59.4 |            8.4 |
|     7 |   111 |   -0.4 | Zumaia   |    68788 |     68710 | 68729 |         -59.4 |           18.2 |
|     8 |   122 |    0.6 | Zumaia   |    69200 |     69107 | 69134 |         -66.4 |           26.4 |
|     9 |   135 |    1.6 | Zumaia   |    69612 |     69517 | 69539 |         -73.4 |           21.8 |
|    10 |   149 |    1.6 | Zumaia   |    70016 |     69928 | 69944 |         -72.4 |           15.6 |
|     9 |   135 |    0.4 | Sopelana |    69612 |     69517 | 69535 |         -76.6 |           18.6 |
|    10 |   149 |      0 | Sopelana |    70016 |     69928 | 69940 |         -75.6 |           12.4 |
|    11 |   160 |     -1 | Sopelana |    70413 |     70334 | 70345 |         -67.6 |             11 |
|    12 |   171 |      0 | Sopelana |    70805 |     70733 | 70750 |         -54.6 |           17.6 |
|    13 |   183 |    0.6 | Sopelana |    71204 |     71125 | 71155 |         -48.6 |           30.6 |
...
#+begin_src R :eval never
  overall_sd |>
    ...
    ## filter(max_age_slider == 200, tiepoint_error == 4.0) |>
    filter(roll == 1e10, frac == 0.25) |>
    select(proxy, site, sol, date, roll, window, RMSD, depth, age_floating, age_slider, kpg_age, age, value, long_ecc_filter = `405 kyr`, short_ecc_filter = `100 kyr`, ecc, ecc_sln) |>
    mutate(comb_ecc_filter = -ecc, .before = ecc_sln) |>
    select(-ecc) |>
    ## distinct(age_slider)
    ## glimpse()
  ## colnames()
  write_csv("out/Zumaia_Sopelana_optimized_taner_filters.csv")
#+end_src

#+begin_src R
  read_csv("out/Zumaia_Sopelana_optimized_taner_filters.csv") |>
    ggplot(aes(x = age * 1e-3, y = comb_ecc_filter, colour = site)) +
    facet_grid(rows = vars(sol), cols = vars(proxy)) +
    geom_line(aes(x = age * 1e-3, y = ecc_sln), inherit.aes = FALSE) +
    geom_line()
#+end_src

#+RESULTS:
: indexing Zumaia_Sopelana_optimized_taner_filters.csv [=-] 180.03GB/s, eta:  0sindexing Zumaia_Sopelana_optimized_taner_filters.csv [====] 1.16GB/s, eta:  0s                                                                                                                 Rows: 26182 Columns: 17
: ── Column specification ──────────────────────────────────────────────────────
: Delimiter: ","
: chr   (4): proxy, site, sol, window
: dbl  (12): roll, RMSD, depth, age_floating, age_slider, kpg_age, age, valu...
: date  (1): date
:
: ℹ Use `spec()` to retrieve the full column specification for this data.
: ℹ Specify the column types or set `show_col_types = FALSE` to quiet this message.
...
** COMMENT ODP Leg 198 Site 1210B
:PROPERTIES:
...
** [#B] COMMENT ODP Leg 207 Site 1258B
:PROPERTIES:
...
** COMMENT Jordanian Levant Platform
:PROPERTIES:
...
** COMMENT apply our method to a hypothetical dataset
:PROPERTIES:
