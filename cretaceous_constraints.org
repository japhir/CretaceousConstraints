...
***** new approach after talking to Luc
:PROPERTIES:
...
#+begin_src R
  ...
  tst1$plot +
    scale_linetype_manual(values = c("ecc construct" = "solid",
                                     "405 kyr" = "dashed",
                                     "100 kyr" = "dotted")) +
    aes(linetype =  "ecc construct") +
    geom_line(aes(y = RMSD_tie_405, group = n, linetype = "405 kyr")) +
    geom_line(aes(y = RMSD_tie_100, group = n, linetype = "100 kyr"))
